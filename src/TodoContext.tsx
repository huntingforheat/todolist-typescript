...
export function useTodoDispatch() {
    ...
    if (!context) {
        throw new Error('Cannot find TodoDispatchContextProvider')
    }
    return context;
}
...
export function useTodoNextId() {
    ...
    if (!context) {
        throw new Error('Cannot find TodoNextIdContextProvider')
    }
    return context;
}